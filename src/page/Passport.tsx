          ...
          >
            <div className='card-body flex flex-col'>
              ...
              <div className='mt-1 flex-auto justify-end'>
                <img src={Stamp} alt='bg' className='background-contain w-28' />
              </div>
              <p className='text-sm'>
                As a traveler, I had the pleasure of visiting the Helsinki
                Cathedral, and it truly left an indelible mark on my journey
                through Finland's capital city. This architectural masterpiece,
                perched atop a majestic flight of stairs
              </p>
