    ...
    <PageLayout>
      <div className='container '>
              ...
              <div className='modal-box'>
                ...
                <div>
                  ...
                  <div className='form-control'>
                    <label className='label cursor-pointer'>
                      <input type='checkbox' className='checkbox mr-2' />
                      <span className='label-text flex-1'>Design and art</span>
                    </label>
                  </div>
                  <div className='form-control'>
                    <label className='label cursor-pointer'>
                  ...
                  <div className='form-control'>
                    <label className='label cursor-pointer'>
                      <input type='checkbox' className='checkbox mr-2' />
                      <span className='label-text flex-1'>Food and drinks</span>
                    </label>
                  </div>
                  <div className='form-control'>
                    <label className='label cursor-pointer'>
        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-3'>
          {places.map((place) => (
            <Link key={place.name} to={`/place/${place.id}`} className='w-full'>
              <div
                key={place.name}
